...
#'
#' @description The \code{MSATBtest} dataset consists of the responses of 1,407 subjects (484 males, 923 females)
...
#'
#' @format A \code{MSATBtest} data frame consists of 1,407 observations on the following 21 variables:
#' \describe{
