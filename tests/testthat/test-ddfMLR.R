test_that("ddfMLR - examples at help page", {
  ...
  # saveRDS(predict(fit1), file = "tests/testthat/fixtures/ddfMLR_fit1_predict.rds")
  fit1_predict_expected <- readRDS(test_path("fixtures", "ddfMLR_fit1_predict.rds"))
  expect_equal(fit1_predict, fit1_predict_expected, tolerance = 1e-3)
  fit1_predict_item3 <- predict(fit1, item = 3)
  # saveRDS(predict(fit1, item = 3), file = "tests/testthat/fixtures/difORD_fit1_predict_item3.rds")
  fit1_predict_item3_expected <- readRDS(test_path("fixtures", "difORD_fit1_predict_item3.rds"))
  expect_equal(fit1_predict_item3, fit1_predict_item3_expected, tolerance = 1e-3)
...
test_that("ddfMLR - checking inputs", {
  ...
  expect_equal(fit1, fit4, tolerance = 1e-3)
  # NA values in key
