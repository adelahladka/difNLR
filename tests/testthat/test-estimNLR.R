test_that("estimNLR - examples at help page", {
  ...
  expect_equal(fit_nls, fit_nls_expected, tolerance = 1e-5)
  ...
  expect_equal(fit_mle, fit_mle_expected, tolerance = 1e-5)
  ...
  expect_equal(fit_em, fit_em_expected, tolerance = 1e-5)
  ...
  expect_equal(fit_plf, fit_plf_expected, tolerance = 1e-5)
  ...
  expect_equal(fit_irls, fit_irls_expected, tolerance = 1e-5)
