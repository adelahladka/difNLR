...
The `GMAT2test` is a generated dataset based on parameters from Graduate
...
respectively. The data set represents responses of 1,000 subjects to
...
indicates focal group. Groups are the same size (i.e. 500 per group).
...
A `GMAT2test` data frame consists of 1,000 observations on the following
21 variables:
